...
public class WebSocketHandler {
    ...
    private WebSocketHandler(String wsHost, String remoteServerRootEndpoint, Client client, Gson gson){
        this.WsHost = wsHost;
    ...
    public static WebSocketHandler create(String wsHost, String remoteServerRootEndpoint, Client client, Gson gson){
        return new WebSocketHandler(wsHost,remoteServerRootEndpoint, client, gson);
    }
